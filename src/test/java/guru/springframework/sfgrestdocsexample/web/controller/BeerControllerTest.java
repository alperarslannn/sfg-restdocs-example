        ...
        mockMvc.perform(get("/api/v1/beer/{beerId}", UUID.randomUUID().toString())
                ...
                .andDo(document("v1/beer-get",
                        ...
                        responseFields(
                                ...
                                fieldWithPath("lastModifiedDate").description("lastModifiedData"),
        ...
        mockMvc.perform(post("/api/v1/beer/")
                ...
                .andDo(document("v1/beer-new",
                        requestFields(
                                ...
                                fields.withPath("beerName").description("beerName"),
                                fields.withPath("beerStyle").description("beerStyle"),
